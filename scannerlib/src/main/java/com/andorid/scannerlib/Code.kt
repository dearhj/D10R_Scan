...
import com.andorid.scannerlib.bean.CodeFunction
...
//                ),
        ...
        CodeObj(
            "ISBT 128", listOf(
                CodeFunction(
                    "On/Off", listOf(
                        Pair("Off", "07 C6 04 08 00 54 00 FE D3"),
                        Pair("On", "07 C6 04 08 00 54 01 FE D2")
                    ), "05 C7 04 00 54 FE DC"
                )
            )
        ),
        CodeObj(
            ...
            "GS1-128 (UCC/EAN-128)", listOf(
                CodeFunction(
                    ...
                    "Send Check Digits", listOf(
                        Pair("Off", "08 C6 04 08 00 F2 36 00 FD FE"),
                        Pair("On", "08 C6 04 08 00 F2 36 01 FD FD")
                    ), "06 C7 04 00 F2 36 FE 07"
                ), CodeFunction(
                    "Message Length", listOf(
        ...
        CodeObj(
            "MicroQRCode", listOf(
                CodeFunction(
                    "On/Off", listOf(
                        Pair("Off", "08 C6 04 08 00 F1 3D 00 FD F8"),
                        Pair("On", "08 C6 04 08 00 F1 3D 01 FD F7")
                    ), "06 C7 04 00 F1 3D FE 01"
                )
            )
        ),
        CodeObj(
        ...
        CodeObj(
            "PLESSEY", listOf(
                CodeFunction(
                    "On/Off", listOf(
                        Pair("Off", "08 C6 04 08 00 F2 34 00 FE 00"),
                        Pair("On", "08 C6 04 08 00 F2 34 01 FD FF")
                    ), "06 C7 04 00 F2 34 FE 09"
                ), CodeFunction(
                    "PLESSEY Check Digit", listOf(
                        Pair("Off", "08 C6 04 08 00 F2 4E 00 FD E6"),
                        Pair("On", "08 C6 04 08 00 F2 4E 01 FD E5")
                    ), "06 C7 04 00 F2 4E FD EF"
                ), CodeFunction(
                    "PLESSEY Send Check Digits", listOf(
                        Pair("Off", "08 C6 04 08 00 F2 4F 00 FD E5"),
                        Pair("On", "08 C6 04 08 00 F2 4F 01 FD E4")
                    ), "06 C7 04 00 F2 4F FD EE"
                )
            )
        ),
        CodeObj(
            "AIM128", listOf(
                CodeFunction(
                    "On/Off", listOf(
                        Pair("Off", "08 C6 04 08 00 F2 29 00 FE 0B"),
                        Pair("On", "08 C6 04 08 00 F2 29 01 FE 0A")
                    ), "06 C7 04 00 F2 29 FE 14"
                ), CodeFunction(
                    "AIM128 Send Check Digits", listOf(
                        Pair("Off", "08 C6 04 08 00 F2 2A 00 FE 0A"),
                        Pair("On", "08 C6 04 08 00 F2 2A 01 FE 09")
                    ), "06 C7 04 00 F2 2A FE 13"
                ), CodeFunction(
                    "AIM128 Message Length", listOf(
                        Pair("A Single Length(06)", "0B C6 04 08 00 F5 0A 06 F5 0B 00 FD 1E"),
                        Pair("Two Separate Lengths", "0B C6 04 08 00 F5 0A 06 F5 0B 04 FD 1A"),
                        Pair(
                            "Length within a specified range(04 until  09)",
                            "0B C6 04 08 00 F5 0A 04 F5 0B 09 FD 17"
                        ),
                        Pair("Arbitrary length", "0B C6 04 08 00 F5 0A 00 F5 0B 00 FD 24")
                    ), "08 C7 04 00 F5 0A F5 0B FD 2E"
                )
            )
        ),
        CodeObj(
    ...
    return mutableListOf(
        CodeObj(
            ...
            listOf(
                ...
                CodeFunction(
                    "Read Code TimeOut(ms)",
                    listOf(),
                    LengthFunction(0, 36000, "ORTSET")
                )
            ),
        ),
        CodeObj(
